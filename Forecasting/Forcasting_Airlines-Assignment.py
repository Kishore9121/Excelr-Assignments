...
##### Import Dataset
df=pd.read_excel('D:/data science/assignments_csv/Airlines+Data.xlsx')
df
...
##### Boxplot for month v/s passengers 
plt.figure(figsize=(8,6))
sns.boxplot(x="month",y="Passengers",data=df)

##### Boxplot for year v/s passengers 
plt.figure(figsize=(8,6))
...
''' I choose Multiple Additive Seasonality model which has lowest RMSE which is
    11.784250.25 when compared to other models and i have created 12 dummy variables
